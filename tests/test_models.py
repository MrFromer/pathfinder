...
class character(models.Model):
    ...
    # armor-класс брони
    armor_class_total = models.IntegerField(blank=True, null = True)
    armor_class_bonus_armor = models.IntegerField(blank=True, null = True)
    armor_class_shield_bonus = models.IntegerField(blank=True, null = True)
    armor_class_dex_modifier = models.IntegerField(blank=True, null = True)
    armor_class_size_modifier = models.IntegerField(blank=True, null = True)
    armor_class_natural_armor = models.IntegerField(blank=True, null = True)
    armor_class_deflection_modifier = models.IntegerField(blank=True, null = True)
    armor_class_misc_modifier = models.IntegerField(blank=True, null = True)
    touch_armor_class = models.CharField(blank=True, null = True, max_length=50)
    flat_footed_armor_class = models.CharField(blank=True, null = True, max_length=50)
